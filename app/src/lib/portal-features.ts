...
export const portalModules: PortalModule[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: "arbeitszeit_jahreskalender", label: "Arbeitszeit - Jahreskalender", path: "/admin/working-time/kalender" },
      { key: "arbeitszeit_planzeiten", label: "Arbeitszeit - Planzeiten", path: "/admin/working-time/planzeiten" },
      ...
      { key: "mitarbeiter_importieren", label: "Mitarbeiter importieren", path: "/employees/imports" },
  ...
  },
  {
    ...
    features: [
      ...
      { key: "buchungsoptionen", label: "Buchungsoptionen", path: "/admin/inventory-booking-options", group: "Inventar" },
