...
export async function GET(
  ...
  const templateName =
    ...
    "Formular";
  const bytes = await createProjectFormPdf({
...
async function createProjectFormPdf(input: {
...
function getCompanyLines(company: CompanyInfo) {
  return [
...
function getCompanyAddress(company: CompanyInfo) {
  return [
    company.street,
...
function getCompanyContacts(company: CompanyInfo) {
  return [
    company.phone,
    company.mobile,
    company.email,
