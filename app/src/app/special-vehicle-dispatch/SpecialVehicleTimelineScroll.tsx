...
function scrollToDate({
  ...
  window.requestAnimationFrame(() => {
    ...
    const targetLeft =
      ...
      Math.max(0, scrollElement.clientWidth / 2 - targetElement.clientWidth / 2);
...
export function SpecialVehicleTimelineScroll({
  focusDate,
  children,
}: {
  focusDate: string;
  ...
  return (
    <div
      ref={scrollRef}
      data-special-vehicle-timeline-scroll-container="true"
